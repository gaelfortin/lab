...
print('----------------------------------')
print('Welcome to DigestMayo 1.1!')
print(' ')
...
print('Final construction length:', len(constr))

print('Sequences importated!')

print(' ')
print('ENZYMES IMPORTATION...')
def file_len(fname):
...
if ddigquestion == 'Y':
    ...
    if (only_constr and only_vec) == set():
        print('There are no enzymes cutting 1x only in vector or construction. Please consider using an enzyme cutting 1x in one plasmid and 2x in the other one (see above).')
    else:
        for elt_com in comenz: #TODO : use enzymes in alphabetic order
...
print(' ')
print('Done! Thanks for using DigestMayo!')
print('Gael Fortin. June 2018')
dna_vec.close()
dna_constr.close()
enzlist.close()
